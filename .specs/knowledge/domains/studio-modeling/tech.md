...
| [`Spec 023`](../../specs/active/023-multi-anchor-distribution-and-auto-scale.md) | Distribution Multi-Ports & Redimensionnement Automatique | Poignées équidistantes sans collision, projection périmétrique 4 flancs, seuil de capacité 8 flux, facteur d'échelle $\times 2$ |
