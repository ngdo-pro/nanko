...
5. BUILD & QA    → Code implementation & quality gates validation
   ↓
6. SYNC BASELINE → Archive spec & update ground truth (.specs/baseline/)
```
...
* **`skills/`**: Agentic skills and slash commands (`/vision`, `/initiative`, `/feature`, `/spec`, `/build-spec`, `/test-spec`, `/sync-baseline`, etc.).
