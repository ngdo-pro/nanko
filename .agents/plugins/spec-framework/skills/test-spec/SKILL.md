...
Use this skill to audit, design, and synchronize tests (unit, integration, E2E) ensuring every behavioral invariant and edge case possesses an automated test AND a matching Gherkin scenario in the active specification (`.specs/changes/active/[id]*.md`).
...
* Load the active specification in `.specs/changes/active/[id]*.md`.
