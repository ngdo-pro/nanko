...
3. Si le domaine existe déjà, lire `.specs/knowledge/domains/[domaine]/` (`behavior.md`, `tech.md`, `contracts.md`, `models.md`) pour connaître exactement le point de départ actuel.
